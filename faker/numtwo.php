...
for ($i = 1; $i <= 20; $i++) {
    ...
    $fake_uid_num = mysqli_real_escape_string($conn, $faker->unique()->numberBetween($min = 1, $max = 100));


    $query = "INSERT INTO carddetail(creditCardType, creditCardNumber, creditCardExpirationDate, userIdNumber) VALUES('$fake_cc_type', '$fake_cc_number', '$fake_cc_exp_date', '$fake_uid_num')";
